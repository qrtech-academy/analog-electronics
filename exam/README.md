...
Newton iterations without limiting and 7 with it; 287 ohm becoming 270 and a forced beta of 9.4;
...
* **The constant-drop model is 0.65 V**, except where a question names the exponential, and then
  ...
  the two a calculation needs. **A saturated switch is the one standing exception at 0.7 V**,
  which is what
  [L05 A.4](../lectures/L05/appendix/a_the_bipolar_transistor.md#a4-designing-a-switch) and
  `baseResistor` both use.
