...
and then $V_{BE} = V_T\ln(I_C/I_S)$. **A saturated switch's base-emitter drop is 0.7 V**, because a
forced beta drives the base far harder than the active region would.
