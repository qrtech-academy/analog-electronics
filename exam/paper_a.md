...
**A saturated switch's base-emitter drop is 0.7 V.** A forced beta drives the base ten times harder
than the active region would, and at 60 mV a decade the junction sits above the 0.65 V of a
small-signal bias point.
