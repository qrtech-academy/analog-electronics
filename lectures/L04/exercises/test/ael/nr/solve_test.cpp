 ...
 */
[[nodiscard]] double byHand(const double supply, const double resistance) noexcept
{
    double voltage{0.65};
    for (int i{}; i < 200; ++i)
    {
...
[[nodiscard]] Netlist diodeThrough(const double supply, const double resistance) noexcept
{
    Netlist netlist{};
