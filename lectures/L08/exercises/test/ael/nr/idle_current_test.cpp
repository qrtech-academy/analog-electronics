...
[[nodiscard]] Netlist half(const double baseVoltage) noexcept
{
    Netlist netlist{};
...
[[nodiscard]] double collectorCurrentAt(const double baseVoltage) noexcept
{
...
[[nodiscard]] double biasFor(const double idle) noexcept
{
    double low{0.40};
    double high{0.95};
