...
4. **The first answer was 12 per cent high**, which is the error taken against the prediction, as
   [A.4](./a_the_quiescent_point.md#a4-stiffness) takes it: $(1.059 - 0.934)/1.059$. Taken against
   the current the stage actually sits at it is 13 per cent, and naming the denominator is the
   whole of the difference. The stiffness is $251/18.7 = 13.4$.
