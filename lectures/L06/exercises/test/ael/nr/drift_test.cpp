...
[[nodiscard]] Netlist stage(const double emitterResistor, const double temperature) noexcept
{
...
[[nodiscard]] double collectorCurrent(const Netlist& netlist) noexcept
{
 ...
 */
[[nodiscard]] double fixedBaseDriftPerDegree() noexcept
{
