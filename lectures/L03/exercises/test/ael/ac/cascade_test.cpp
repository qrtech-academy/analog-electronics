...
[[nodiscard]] double corner() noexcept { return 1.0 / (2.0 * M_PI * Resistance * Capacitance); }
 ...
 */
[[nodiscard]] double halfPower(const Netlist& netlist, const Node output) noexcept
{
