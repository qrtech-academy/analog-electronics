...
[[nodiscard]] constexpr double emitterFactor(const double current, const double emitter) noexcept
{
...
[[nodiscard]] constexpr double resistanceIntoCollector(const double current,
                                                       const double emitter) noexcept
{
