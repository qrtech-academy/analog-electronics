...
# Everything LuaLaTeX writes while building the book. The PDF it ends with,
# book/analog-electronics.pdf, is committed, like the generated figures, and is not removed here.
remove book/build
